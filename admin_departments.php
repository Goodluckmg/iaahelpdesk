...
<div class="app-container">
    <aside class="sidebar">
        ...
        <div class="nav-menu">
            ...
            <a href="users.php" class="nav-item"><i class="fas fa-users"></i><span class="nav-label">User Management</span></a>
            <a href="tickets.php" class="nav-item"><i class="fas fa-ticket-alt"></i><span class="nav-label">All Tickets</span></a>
