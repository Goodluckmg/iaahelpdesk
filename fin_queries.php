...
// Build query for finance department tickets
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sidebar { width: 260px; background: linear-gradient(180deg, #0a2b38, #0d3b4c); color: white; padding: 20px; min-height: 100vh; }
        ...
        .nav-item { color: white; text-decoration: none; padding: 12px 15px; border-radius: 8px; display: flex; align-items: center; gap: 12px; transition: background 0.2s; }
        ...
        .filter-btn { background: #f0f0f0; border: none; padding: 8px 20px; border-radius: 20px; cursor: pointer; transition: 0.2s; text-decoration: none; color: #333; }
        .filter-btn.active { background: #f39c12; color: white; }
        ...
        .btn-primary { background: #f39c12; color: white; border: none; padding: 8px 16px; border-radius: 20px; cursor: pointer; text-decoration: none; display: inline-flex; align-items: center; gap: 8px; font-size: 0.8rem; }
