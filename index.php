...
<div class="app-container">
    ...
    <aside class="sidebar">
        ...
        <div class="nav-menu">
            <a href="index.php" class="nav-item active"><i class="fas fa-chart-pie"></i><span class="nav-label">Dashboard</span></a>
    ...
    <main class="main-content">
        ...
        <div class="widget-card">
            <div class="flex-between">
                ...
                <a href="submit-query.php" class="btn-primary"><i class="fas fa-plus"></i> New Query</a>
            </div>
            <table>
                <thead>
...
<script>
    function renderDashboard() {
        ...
        if (recent.length === 0) {
            tbody.innerHTML = '<tr><td colspan="5">No queries yet. Submit one.</td></tr>';
        } else {
            tbody.innerHTML = recent.map(t => `
                <tr>
                    <td>#${t.id}</td>
                    <td>${escapeHtml(t.title.substring(0, 40))}</td>
                    <td>${t.department}</td>
