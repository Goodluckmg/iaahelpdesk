...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .btn-primary { background: #667eea; border: none; padding: 8px 20px; border-radius: 25px; color: white; cursor: pointer; font-size: 0.8rem; transition: 0.2s; }
        ...
        .search-box input { flex: 1; padding: 10px 15px; border: 1px solid #ddd; border-radius: 25px; outline: none; }
        .filter-tabs { display: flex; gap: 10px; margin-bottom: 20px; flex-wrap: wrap; }
        .filter-btn { background: #f0f0f0; border: none; padding: 6px 16px; border-radius: 20px; cursor: pointer; font-size: 13px; transition: 0.2s; }
        ...
        .evidence-box { background: #f8fafc; border-radius: 12px; padding: 10px; border: 1px dashed #667eea; }
    ...
    <main class="main-content">
        ...
        <div class="widget-card">
            <form method="GET" action="" class="search-box" style="display: flex; gap: 10px; margin-bottom: 20px;">
                ...
                <a href="lec_pending.php" class="btn-primary" style="background:#27ae60;"><i class="fas fa-sync-alt"></i> Refresh</a>
            </form>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars(substr($row['title'], 0, 40)); ?>电子
    ...
    <div class="modal-content">
        ...
        <form method="POST" action="">
            ...
            <div class="form-group" id="documentDiv" style="display:none;">
                ...
                <div class="evidence-box" style="background:#f8fafc; border-radius:12px; padding:10px; border:1px dashed #667eea; display:flex; align-items:center; justify-content:space-between; flex-wrap:wrap; gap:10px;">
