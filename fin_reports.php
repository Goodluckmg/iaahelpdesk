...
// Get monthly trends (last 6 months) with prepared statement
$trend_query = "SELECT 
...
<head>
    ...
    <style>
        /* =========================================
           FINANCE REPORTS STYLES - TULI KABISA
           ========================================= */
    ...
    new Chart(ctx2, {
        ...
        data: {
            ...
            datasets: [{
                ...
                backgroundColor: ['#e74c3c', '#f39c12', '#1d6f42']
            }]
        },
        options: {
            responsive: true,
